...
const World = dynamic(() => import('./globe-section').then((m) => m.World), {
  ssr: false,
})
...
export function GlobeDemo() {
  ...
  return (
    <div className="relative z-0 flex min-h-screen w-full flex-row items-center justify-center bg-white py-20 dark:bg-black md:h-auto">
